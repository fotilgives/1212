    ...
    <section id="top" className="relative">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        >
          ...
          {/* ── Bio text ── */}
          <motion.p variants={itemV} className="text-sm leading-relaxed text-slate-600">
        ...
        <div className="hidden lg:block py-20 xl:py-24">
          ...
          <div className="grid items-start gap-12 xl:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)]">
            ...
            >
              {/* Floating 3D Heart (Desktop) */}
              <motion.div
                className="absolute -left-12 top-24 z-40 w-36 h-36 pointer-events-none drop-shadow-2xl"
                animate={{ y: [0, -20, 0], rotate: [0, 5, -5, 0] }}
                transition={{ duration: 6, repeat: Infinity, ease: 'easeInOut' }}
                style={{ transform: 'translateZ(60px)' }}
              >
                <img src="/images/3d-heart.jpg" alt="3D Heart" className="w-full h-full object-contain mix-blend-multiply rounded-full" />
              </motion.div>
