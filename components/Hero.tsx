...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-28 pb-12 px-6 md:px-8 overflow-hidden bg-[#fdfdfd]">
      {/* Grain Texture Overlay - Masks pixelation and adds premium feel */}
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-4 items-center z-10">
        ...
        <div className="lg:col-span-6 order-2 lg:order-1 space-y-12 text-center lg:text-left">
          <div className="space-y-8">
            ...
            <h1 className="font-playfair text-6xl md:text-8xl lg:text-[120px] leading-[0.85] font-medium tracking-tighter text-neutral-900">
              Світлана <br />
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start pt-4">
            ...
            <a href="#gallery" className="inline-flex items-center justify-center space-x-4 group py-6">
               <span className="text-[11px] font-bold uppercase tracking-[0.25em] border-b border-black pb-1 group-hover:text-neutral-400 group-hover:border-neutral-200 transition-all">Дивитись портфоліо</span>
            </a>
          </div>
        </div>
        ...
        <div className="lg:col-span-6 order-1 lg:order-2 flex justify-center lg:justify-end relative">
          <div className="relative w-full max-w-[380px] lg:max-w-[440px]">
            ...
            <div className="relative aspect-[3/4] rounded-t-full rounded-b-[40px] overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] bg-white ring-8 ring-white/50">
              <img 
                src="blob:https://gemini.google.com/69d9d1fb-a802-425a-845e-c36282b27981$0.image.png" 
                alt="Світлана Мазур" 
              ...
              />
              {/* Soft Gradient Overlay to blend sharp edges if any */}
