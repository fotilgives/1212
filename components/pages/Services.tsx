...
const SERVICES_DATA: ServiceItem[] = [
  ...
  {
    title: 'Йога та фізична реабілітація',
    image: '/images/physical_therapy.jpg',
    short: 'Адаптивна йога та ЛФК для відновлення рухових функцій, балансу та гнучкості тіла.',
    details: 'Заняття поєднують елементи терапевтичної йоги з лікувальною фізкультурою: індивідуально підібрані асани зміцнюють глибокі м’язи, покращують координацію та відновлюють природний обсяг рухів у суглобах.',
    cases: [
  ...
  {
    title: 'Заняття з нейровправами',
    image: '/images/ergotherapy.jpg',
