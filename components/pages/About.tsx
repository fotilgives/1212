...
const About: React.FC<Props> = ({ embedded = false }) => {
    ...
    <Wrapper className={embedded ? '' : 'mx-auto max-w-4xl px-5 pb-20 pt-12 sm:pt-16'}>
      ...
      >
        ...
        <div className="card-glow rounded-3xl p-6 ring-1 ring-white/60">
          ...
          <span className="mt-4 grid h-12 w-12 place-items-center rounded-2xl bg-emerald-600 text-white shadow-lg shadow-emerald-200">
